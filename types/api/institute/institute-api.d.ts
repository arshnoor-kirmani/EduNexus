...
// }
// // ====================
type InstituteCodeSuccess = {
  success: true;
  institute_code: string;
};

type InstituteCodeFailure = {
  success: false;
  institute_code: string; // fallback, still safe usable
  message: string;
};

type InstituteCodeResponse = InstituteCodeSuccess | InstituteCodeFailure;
export type InstituteCheckEmailResponse = {
